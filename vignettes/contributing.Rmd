...
Thank you for taking the time to contribute to safir2.
...
We periodically merge `dev` into `master` for small release updates. These releases will appear on the [GitHub releases page](https://github.com/mrc-ide/safir2/releases). 
...
runs during any push to `[main, feat/*, hotfix/*, bug/*, dev]` branches.

[Test coverage](https://github.com/r-lib/actions/blob/master/examples/test-coverage.yaml)
runs during pull requests to `[main, dev]` and uses our [codecov.io integration](https://app.codecov.io/gh/mrc-ide/safir2)
...
workflows. If you find a strange or unusual bug when pushing to a branch, this
is one thing to consider checking.
