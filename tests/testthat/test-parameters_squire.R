...
test_that("test get_squire_parameters returns the correct values from SQUIRE", {
...
test_that("test that if max-age is set as NULL get_squire_parameters returns the
