...
#' @export
get_squire_parameters <- function(iso3c = NULL,
                           population = NULL,
  ...
  pars$beta_set <- interp_input_par(
    ...
    c(pars$beta_set, tail(pars$beta_set, 1L))
  )
...
#' @title Function to add asymptomatic information
...
#' @title Interpolate input parameters
